...
public class ModificaCancela {
    ...
    public GridPane modificaCancela() {
        ...
        buttonAcepId.setOnAction((event) -> {
            ...
            if (!textFieldId.getText().trim().equals("")
                    && logicaPila.existeCita(textFieldId.getText(), comboBoxClientes.getValue().toString())) {
        ...
        buttonCancelarCita.setOnAction((event) -> {
            ...
            alerta.alertInformation("Se canceló su cita, correctamente");
        ...
        buttonCerrar.setOnAction((event) -> {
            ...
            gridPaneModificaCancela.getChildren().add(o.menuAdministrador());

        });

        return gridPaneModificaCancela;
    }//end gridPaneModificaCancela
